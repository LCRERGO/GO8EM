...
func TestExec(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			args: argument.ParseArguments(0xF065),
		...
		},
		{
			...
			args: argument.ParseArguments(0xFF65),
		...
		},
		{
			...
			args: argument.ParseArguments(0xF765),
